...
Niewłaściwa konfiguracja zabezpieczeń odnosi się do sytuacji, w których aplikacja jest podatna na ataki z powodu braku odpowiedniego hardeningu w dowolnej części stosu aplikacji lub niewłaściwie skonfigurowanych uprawnień w usługach chmurowych. Przykłady obejmują:
    włączone lub zainstalowane niepotrzebne funkcje (np. nieużywane porty, usługi, strony, konta lub uprawnienia);
